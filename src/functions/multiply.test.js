...
describe('multiply.js', () => {
  it('multiply arnums', () => {
    ...
    expect(multiplyArnums(
      [3, 2, 1],
      [2, 2]
    )).toEqual(arnum('2000000600000100000006'))

    expect(multiplyArnums(
      arnum('30670611727837901192'),
      arnum('81126840202085220867')
    )).toEqual(arnum('2488209816544506301085316034759042573464'))
