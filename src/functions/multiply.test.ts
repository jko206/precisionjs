...
const n1 = getArnum('2000000600000100000006')
const n2 = getArnum('30670611727837901192')
const n3 = getArnum('81126840202085220867')
const n4 = getArnum('2488209816544506301085316034759042573464')
const n5 = getArnum('605881025935900057632270154397334802003')
const n6 = getArnum('5534011216879981365928981304952000318')
const n7 = getArnum('5667248510129402406278002221897072087915')
const n8 = getArnum('2866181414294083680568129177973394313695')
// prettier-ignore
const n9 = getArnum(
  `
